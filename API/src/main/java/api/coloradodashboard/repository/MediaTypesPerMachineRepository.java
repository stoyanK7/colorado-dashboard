...
public interface MediaTypesPerMachineRepository extends JpaRepository<MediaTypesPerMachineEntity, Long>,
    ...
    @Query("SELECT new api.coloradodashboard.dto.MediaTypesPerMachineDto(DATE_FORMAT(m.date, :dateFormat) AS formatted_date, m.mediaCategory, SUM(m.printedSquareMeters)) " +
    ...
    @Query("SELECT new api.coloradodashboard.dto.MediaTypesPerMachineDto(DATE_FORMAT(m.date, :dateFormat) AS formatted_date, m.printerId, m.mediaCategory, SUM(m.printedSquareMeters)) " +
            "FROM MediaTypesPerMachineEntity m " +
